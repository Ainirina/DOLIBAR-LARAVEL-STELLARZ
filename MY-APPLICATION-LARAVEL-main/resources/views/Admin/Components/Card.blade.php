<section class="rounded-xl bg-[#0D0D0D] font-normal text-[#F4F4F4]   shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
    ...
    <header class="flex flex-col gap-3 px-6 py-4 border-b bg-[#0D0D0D] font-normal text-[#F4F4F4]  border-gray-200 dark:border-white/10">
